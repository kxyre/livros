    ...
    <div class="container mt-3 mb-3">
        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                $fotoProduto = $nomeProduto = $descricaoProduto = $idUsuario = "";
                $editoraLivro = $idiomaLivro = $generoLivro = "";
                ...
                if(empty($_POST["editoraLivro"])){
                    ...
                    $editoraLivro = filtrar_entrada($_POST["editoraLivro"]);
                }

                 if(empty($_POST["numeroLivro"])){
                    echo "<div class='alert alert-warning text-center'>O campo <strong>NÚMERO DE PÁGINAS</strong> é obrigatório!</div>";
                    $erroPreenchimento = true;
                }
                else{
                    //Armazena valor do formulário na variável
                    $numeroLivro = filtrar_entrada($_POST["numeroLivro"]);
                }

                 if(empty($_POST["generoLivro"])){
                    echo "<div class='alert alert-warning text-center'>O campo <strong>GÊNERO</strong> é obrigatório!</div>";
                    $erroPreenchimento = true;
                }
                else{
                    //Armazena valor do formulário na variável
                    $generoLivro = filtrar_entrada($_POST["generoLivro"]);
                }
                ...
                //Validação do campo idUsuario
                //Utiliza a função empty() para verificar se o campo está vazio
                if(empty($_POST["idUsuario"])){
                    echo "<div class='alert alert-warning text-center'>O campo <strong>USUARIO</strong> é obrigatório!</div>";
                    $erroPreenchimento = true;
                }
                else{
                    //Armazena valor do formulário na variável
                ...
                if(!$erroPreenchimento && !$erroUpload){
                    ...
                    $inserirProduto = "INSERT INTO Produtos (fotoProduto, nomeProduto, descricaoProduto,  editoraLivro, numeroLivro, generoLivro, statusProduto, idUsuario) 
                    VALUES ('$fotoProduto', '$nomeProduto', '$descricaoProduto', '$editoraLivro', '$numeroLivro', '$generoLivro','disponivel', '$idUsuario' )";
                            ...
                            <div class='container mt-3'>
                                ...
                                <table class='table'>
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <th>NÚMERO DE PÁGINAS DO LIVRO</th>
                                        <td>$numeroLivro</td>
                                    </tr>
                                    <tr>
                                        <th>CONTATO DE USUÁRIO</th>
                                        <td>$idUsuario</td>
                                    </tr>
                                </table>
                            </div>
