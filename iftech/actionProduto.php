        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if(!$erroPreenchimento && !$erroUpload){
                    ...
                    $inserirProduto = "INSERT INTO Produtos (fotoProduto, nomeProduto, descricaoProduto, valorProduto,  editoraLivro, numeroLivro, generoLivro, statusProduto, idUsuario) 
                    VALUES ('$fotoProduto', '$nomeProduto', '$descricaoProduto', '$valorProduto',  '$editoraLivro', '$numeroLivro', '$generoLivro','disponivel', '$id_usuario' )";
